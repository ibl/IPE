...
$(document).ready(function () {
 ...
 // The manifest module loader.
    (function (el) {
        IPE.get.json("http://tcga.github.io/authors.json", function (err, manifests) {
            var authors;
            ...
            authors.addEventListener("change", function (manifestListEvent) {
                        ...
                        if (elButton === null) {
                            ...
                            elButton.addEventListener("click", function (buttonEvent) {
                                ...
                                IPE.loadScript({
                                    ...
                                    if (err) {
                                        IPE.ui.toast.error("An error occurred when loading module \"" + moduleListEvent.target.value + "\".");
                                    } else {
                                        IPE.ui.toast.success("Module " + url + " was successfully loaded.");
                                    }
                                });
             ...
             // Download manifest.
                IPE.loadScript({
                    ...
                    if (err) {
                        IPE.ui.toast.error("Loading selected manifest failed.");
                    }
                });
            });
        });
